...
python ./ai_indexer/extract_resourcecenter_jsonl.py --input ./dqm/temp --output ./dqm/extracted/resource_center.jsonl

python ./ai_indexer/build_chroma_index.py --input ./dqm/extracted/pages.jsonl ./dqm/extracted/profiles.jsonl ./dqm/extracted/terminology.jsonl ./dqm/extracted/examples.jsonl ./dqm/extracted/cql.jsonl ./dqm/extracted/resource_center.jsonl --db-path ./dqm/index/chroma --collection ig_chunks